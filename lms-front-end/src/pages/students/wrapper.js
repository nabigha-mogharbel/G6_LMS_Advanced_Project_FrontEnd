...
export default function ClassWrapper(props) {
 ...
 /* const toggleEdit=(i)=>{
  ...
  return (<div className='dashboard'>
    ...
    {!isListPage && <Single index={studentIndex} dimHandler={shaddowHandler} edit={toggleEdit} cancel={toggleList}/>}
    {add && <Popup><Add cancel={toggleAdd}/></Popup>}
    {edit && <Popup><Edit cancel={toggleEdit} index={studentIndex} /></Popup>}
