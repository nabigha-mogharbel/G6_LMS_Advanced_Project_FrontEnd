...
export default function Students(props) {
  ...
  useEffect(() => {
    ...
    const abouzada = axios.get(`${URL}students`, config).then(
      function (response) {
      ...
      <div className="table-wrapper">
        ...
        <div className="dash-container-scroll">
          <table className="table">
            <thead>
              <tr className="Classes-tr" onClick={()=>  console.log('hello')}>
                <th
                ...
                <th
                  className="Classes-th"
                  ref={nameSort}
                  onClick={(e) => sortClasses(nameSort, "firstname")}
                >
                FirstName
                </th>
                <th
                  className="Classes-th"
                  ref={nameSort}
                  onClick={(e) => sortClasses(nameSort, "lastname")}
                >
                LastName
                </th>
                <th
                  className="Classes-th"
                  ref={floorSort}
                  onClick={(e) => sortClasses(floorSort, "email")}
                >
                  Email
                </th>
                <th
                  className="Classes-th"
                  ref={floorSort}
                  onClick={(e) => sortClasses(floorSort, "phonenumber")}
                >
                  phonenumber
                </th>
              ...
              {classes.data.map((e) => {
                ...
                return (
                  <tr className="Classes-tr gray" key={e.id}>
                    ...
                    <td className="Classes-td">{e.last_name}</td>
                    <td className="Classes-td">{e.email}</td>
                    <td className="Classes-td">{e.phone_number}</td>
                    <td
